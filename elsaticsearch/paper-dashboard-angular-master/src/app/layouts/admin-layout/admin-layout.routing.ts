...
import { DataAumComponent } from 'app/ElasticSearch/data-aum/data-aum.component';
import { SearchDataAumComponent } from 'app/ElasticSearch/search-data-aum/search-data-aum.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'DataAumComponent', component: DataAumComponent },
    { path: 'SearchDataAumComponent', component: SearchDataAumComponent },
